...
set -g status-right "#[fg=#1F1D2E,bg=#1F1D2E,bold,nounderscore,noitalics]#[fg=#569FBA,bg=#1F1D2E] #{prefix_highlight} #[fg=#555169,bg=#1F1D2E,bold,nounderscore,noitalics]#[fg=#569FBA,bg=#555169] %Y-%m-%d %I:%M %p #[fg=#569FBA,bg=#555169,bold,nounderscore,noitalics]#[fg=#393552,bg=#569FBA,bold] #h "
