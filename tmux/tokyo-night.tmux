...
#+--- Windows ---+
# Focus
tmux set -g window-status-current-format "#[fg=black,bg=brightblue] #[fg=#050505]#I #[bold,nodim]#W#[nobold,dim]#{?window_zoomed_flag, $zoom_number, $custom_pane} "
# Unfocused
tmux set -g window-status-format "#[fg=#c0caf5,bg=default,none,dim] #I #W#[nobold,dim]#{?window_zoomed_flag, $zoom_number, $custom_pane}#[fg=brightyellow] #{?window_last_flag,󰁯 ,}"
