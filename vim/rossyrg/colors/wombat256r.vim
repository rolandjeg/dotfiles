...
call <SID>X("Normal",		"cccccc",	"1c1c1c",	        "none")
call <SID>X("Cursor",		"222222",	"ecee91",	"none")
...
call <SID>X("WarningMsg",	"ff0000",	"",			"")
			...
			"MoreMsg
			"Directory
call <SID>X("DiffAdd",     "",   "005000",   "")
call <SID>X("DiffChange",  "",   "306b8f",   "")
call <SID>X("DiffDelete",  "6d3030",   "6d3030",   "")
call <SID>X("DiffText",    "",   "000040",   "")
